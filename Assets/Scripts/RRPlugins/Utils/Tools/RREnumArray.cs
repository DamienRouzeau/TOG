...
//! @class RREnumArrayBaseClass
//!
//! @brief base class only used to display properly in Editor
public abstract class RREnumArrayBaseClass
{
...
[System.Serializable]
public class RREnumArray<t_Enum, t_Content> : RREnumArrayBaseClass, IEnumerable<t_Content>, ISerializationCallbackReceiver where t_Enum : struct, IConvertible
{
	[SerializeField]
...
//#endif // UNITY_EDITOR
	...
	public t_Content this[int nIndex]
	{
		get
		{
			Debug.Assert(nIndex < m_internalArray.Length, $"nIndex out of bounds in {typeof(t_Enum)}");
			Debug.Assert(nIndex >= 0, $"nIndex out of bounds in {typeof(t_Enum)}");
	...
	public RREnumArray(RREnumArray<t_Enum, t_Content> source) : this()
	{
...
#region ISerializationCallbackReceiver
	void ISerializationCallbackReceiver.OnAfterDeserialize()
	{
		...
		Debug.Assert( contents.Count==sNames.Count );
		...
		Debug.Assert( contents.Count==sNames.Count );
		Debug.Assert( contents.Count==sEnumNames.Length );

		m_internalArray = contents.ToArray();
		m_enumNames = sNames.ToArray();
#else
		Debug.Assert( m_internalArray.Length==System.Enum.GetValues( typeof( t_Enum ) ).Length, "The project needs to be recompiled and saved before building." );
#endif // UNITY_EDITOR
	}
...
//! @class RREnumArrayUtility
//!
//! @brief	Static class that adds utility methods for RREnumArray
public static class RREnumArrayUtility
{
	//! @brief Convert an array of booleans into an integer
	//!
	//! @return the array of booleans as an integer
	public static int ToInt<t_Enum>( this RREnumArray<t_Enum, bool> sourceArray ) where t_Enum : struct, IConvertible
	{
		int nEnumerationLength = System.Enum.GetValues( typeof( t_Enum ) ).Length;
		Debug.Assert( nEnumerationLength<=sizeof( int )*8 );
	...
	public static void FromInt<t_Enum>( this RREnumArray<t_Enum, bool> array, int source ) where t_Enum : struct, IConvertible
	{
		int nEnumerationLength = System.Enum.GetValues( typeof( t_Enum ) ).Length;
		Debug.Assert( nEnumerationLength<=sizeof(int)*8 );
	...
	public static uint ToUInt<t_Enum>( this RREnumArray<t_Enum, bool> sourceArray ) where t_Enum : struct, IConvertible
	{
		int nEnumerationLength = System.Enum.GetValues( typeof( t_Enum ) ).Length;
		Debug.Assert( nEnumerationLength<=sizeof( int )*8 );
	...
	//!
	//! @param	source	array of booleans as an integer
	public static void FromUInt<t_Enum>( this RREnumArray<t_Enum, bool> array, uint source ) where t_Enum : struct, IConvertible
	{
		int nEnumerationLength = System.Enum.GetValues( typeof( t_Enum ) ).Length;
		Debug.Assert( nEnumerationLength<=sizeof( int )*8 );
