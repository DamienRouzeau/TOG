...
public static class ExcelUtils
{
	...
	public static int FindRow(ExcelWorksheet worksheet, int columnIndex, object value, int firstRowIndex, int lastRowIndex)
	{
		...
		Debug.Assert(columnIndex >= 1  &&  columnIndex <= worksheet.Dimension.Columns, "Invalid columnIndex : " + columnIndex);
        Debug.Assert(firstRowIndex >= 1  &&  lastRowIndex <= worksheet.Dimension.Rows, "Invalid firstRowIndex : " + firstRowIndex);
        Debug.Assert(lastRowIndex >= 1  &&  lastRowIndex <= worksheet.Dimension.Rows, "Invalid lastRowIndex : " + lastRowIndex);
	...
	{
        Debug.Assert(worksheet != null);
        Debug.Assert(rowIndex >= 1  &&  rowIndex <= worksheet.Dimension.Rows, "Invalid rowIndex : " + rowIndex);
        Debug.Assert(firstColumnIndex >= 1  &&  firstColumnIndex <= worksheet.Dimension.Columns, "Invalid firstColumnIndex : " + firstColumnIndex);
        Debug.Assert(lastColumnIndex >= 1  &&  lastColumnIndex <= worksheet.Dimension.Columns, "Invalid lastColumnIndex : " + lastColumnIndex);
