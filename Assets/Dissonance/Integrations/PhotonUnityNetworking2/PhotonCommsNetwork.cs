...
namespace Dissonance.Integrations.PhotonUnityNetworking2
{
    ...
    public class PhotonCommsNetwork
        : BaseCommsNetwork<PhotonServer, PhotonClient, int, Unit, Unit>, IOnEventCallback
    {
        ...
        private void OnMasterClientSwitched([NotNull] Player newMasterClient)
        {
        ...
        // ReSharper disable once UnusedMember.Local (Justification: invoked indirectly by photon)
        private void OnPhotonPlayerDisconnected([NotNull] Player player)
        {
