...
namespace FIMSpace.FOptimizing
{
    ...
    public abstract partial class FOptimizer_Base : MonoBehaviour
    {
        ...
        protected virtual void InitBaseCullingVariables(Camera targetCamera)
        {
            ...
            if (targetCamera == null) Debug.LogError("[OPTIMIZERS] There is no main camera on scene!");
        ...
        {
            if (FadeDuration <= 0f) SetLODLevel(lodLevel); // No transitioning, just assigning parameters
            else
            {
