...
namespace FIMSpace.FOptimizing
{
    ...
    public partial class FComponentLODsController
    {
        ...
        public void Editor_DrawValues(int selectedLOD = 0)
        {
            ...
            if (editorHeader != "") headerText = editorHeader;
            ...
            if (optimizer.ToOptimize.IndexOf(this) % 2 == 0)
                EditorGUILayout.BeginVertical(FEditor.FEditor_StylesIn.LGrayBackground);
            else
                EditorGUILayout.BeginVertical(FEditor.FEditor_StylesIn.Style(new Color32(190, 190, 190, 72)));
