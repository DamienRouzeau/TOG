...
namespace FIMSpace.FOptimizing
{
    public abstract partial class FOptimizer_Base
    {
        ...
        private void InitTriggerOptimizer()
        {
            ...
            Transform cam = FOptimizers_Manager.MainCamera != null ? FOptimizers_Manager.MainCamera.transform : null;
            ...
            if ( CullIfNotSee) InitDynamicOptimizer();
        ...
        protected void GenerateTriggerHelpers()
        {
            if (triggersContainer == null)
            {
                ...
                for (int i = 0; i < DistanceLevels.Length; i++)
                {
                    ...
                    go.AddComponent<FOptimizers_TriggerHelper>().Initialize(this, i);
                }
            }
        }
