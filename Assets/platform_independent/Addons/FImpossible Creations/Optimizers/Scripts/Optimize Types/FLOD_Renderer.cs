            ...
            if (rend) if (!optimizer.ContainsComponent(rend))
                {
                    ...
                    if (skinned)
                    {
                        ...
                        return new FComponentLODsController(optimizer, skinned, "Skinned Renderer Settings", this);
                    }
                    else
                    {
                        ...
                        if (mesh)
                        {
                            ...
                            return new FComponentLODsController(optimizer, mesh, "MeshRenderer Settings", this);
                        }
                    }
                }
