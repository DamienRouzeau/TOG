Shader "Hidden/Toony Colors Pro 2/Standard PBS Outline Blended"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			//TCP2
			#pragma shader_feature_local TCP2_DISABLE_WRAPPED_LIGHT
			#pragma shader_feature_local TCP2_RAMPTEXT
			#pragma shader_feature_local TCP2_SPEC_TOON
			#pragma shader_feature_local TCP2_STYLIZED_FRESNEL
