...
Shader "Toony Colors Pro 2/User/TOG_Cartoon_Alpha"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom noambient vertex:vert keepalpha exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
