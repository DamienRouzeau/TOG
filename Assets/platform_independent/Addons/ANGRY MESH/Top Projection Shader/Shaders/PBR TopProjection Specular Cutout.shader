...
Shader "ANGRYMESH/PBR TopProjection Specular Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 triplanar362 = TriplanarSamplingSNF( _TopNormalMap, ase_worldPos, ase_worldNormal, 1.0, TopUVScale197, 0 );
			float3 tanTriplanarNormal362 = mul( ase_worldToTangent, triplanar362 );
			float2 appendResult367 = (float2(_TopNormalIntensity , _TopNormalIntensity));
			float3 appendResult368 = (float3(appendResult367 , 1.0));
			...
			float3 lerpResult158 = lerp( BlendNormals( UnpackScaleNormal( tex2D( _DetailNormalMap, DetailUVScale191 ) ,_DetailNormalMapIntensity ) , tex2DNode96 ) , BlendNormals( UnpackScaleNormal( tex2D( _BaseNormalMap, uv_BaseNormalMap ) ,0.5 ) , ( tanTriplanarNormal362 * appendResult368 ) ) , TopMask168);
			...
			float4 switchResult371 = (((i.ASEVFace>0)?(lerpResult334):(( lerpResult334 * _BaseBackSideMultiply ))));
			o.Albedo = switchResult371.rgb;
			...
			float lerpResult217 = lerp( ( SpecularAlphaSmoothness309 + (-1.0 + (_BaseSmoothness - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) , ( TopAlphaSmoothness220 + (-1.0 + (_TopSmoothness - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) , TopMask168);
			...
			o.Alpha = 1;
			float BaseAlphaCutout212 = tex2DNode162.a;
			clip( BaseAlphaCutout212 - _Cutoff );
		}
...
/*ASEBEGIN
Version=13801
1929;30;1901;1002;1642.64;1001.67;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;287;-2640,608;Float;True;Property;_BaseNormalMap;Base Normal Map;8;1;[Normal];None;True;bump;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.SamplerNode;162;-2048,-2048;Float;True;Property;_BaseAlbedoACutoutMask;Base Albedo (A CutoutMask);6;0;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-2432,-640;Half;False;Property;_TopUVScale;Top UV Scale;11;0;1;0.1;10;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;139;-2672,1312;Fixed;False;Property;_TopNormalIntensity;Top Normal Intensity;15;0;2;0;2;0;1;FLOAT
...
Node;AmplifyShaderEditor.TexturePropertyNode;365;-2384,-864;Float;True;Property;_TopAlbedoASmoothness;Top Albedo (A Smoothness);17;1;[NoScaleOffset];Assets/ANGRY MESH/Top Projection Shader/Sources/Textures/Snow_01_Albedo.tga;False;gray;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.RangedFloatNode;369;-2176,1408;Float;False;Constant;_Blue;Blue;23;0;1;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.DynamicAppendNode;367;-2176,1280;Float;False;FLOAT2;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT2
...
Node;AmplifyShaderEditor.TexturePropertyNode;366;-2640,976;Float;True;Property;_TopNormalMap;Top Normal Map;18;2;[Normal];[NoScaleOffset];Assets/ANGRY MESH/Top Projection Shader/Sources/Textures/Snow_01_NM.tga;True;bump;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.GetLocalVarNode;198;-2608,1200;Float;False;197;0;1;FLOAT
...
Node;AmplifyShaderEditor.TriplanarNode;363;-2048,-832;Float;True;Spherical;World;False;Top Texture 1;_TopTexture1;gray;1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Top Albedo (A Smoothness);False;8;0;SAMPLER2D;;False;5;FLOAT;1.0;False;1;SAMPLER2D;;False;6;FLOAT;0.0;False;2;SAMPLER2D;;False;7;FLOAT;0.0;False;3;FLOAT;0.0;False;4;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;307;-5120,1792;Float;True;Property;_BaseSpecularASmoothness;Base Specular (A Smoothness);7;0;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.DynamicAppendNode;368;-1904,1280;Float;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.TriplanarNode;362;-2176,1024;Float;True;Spherical;World;True;TriplanarNormal;_TriplanarNormal;bump;1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Normal;False;8;0;SAMPLER2D;;False;5;FLOAT;1.0;False;1;SAMPLER2D;;False;6;FLOAT;0.0;False;2;SAMPLER2D;;False;7;FLOAT;0.0;False;3;FLOAT;0.0;False;4;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.GetLocalVarNode;310;-5008,-896;Float;False;309;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;370;-1760,1024;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.ColorNode;373;-1008,-512;Float;False;Property;_BaseBackSideMultiply;Base Back Side Multiply;5;0;1,1,1,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;372;-624,-512;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0.0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.GetLocalVarNode;360;-1164.007,1745.75;Float;False;-1;0;1;OBJECT
...
Node;AmplifyShaderEditor.SwitchByFaceNode;371;-384.98,-662.6757;Float;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.GetLocalVarNode;357;-640,1152;Float;False;356;0;1;COLOR
Node;AmplifyShaderEditor.RegisterLocalVarNode;212;-1647,-1952;Float;False;BaseAlphaCutout;-1;True;1;0;FLOAT;0,0,0,0;False;1;FLOAT
Node;AmplifyShaderEditor.GetLocalVarNode;361;-640,1280;Float;False;212;0;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;112,752;Float;False;True;2;Float;;0;0;StandardSpecular;ANGRYMESH/PBR TopProjection Specular Cutout;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;0;False;0;0;Custom;0.5;True;True;0;True;TransparentCutout;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;0;8.6;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;367;0;139;0
WireConnection;367;1;139;0
...
WireConnection;0;10;361;0
ASEEND*/
//CHKSM=3BEB741A626751067185F79D2383AFF91383FA6A