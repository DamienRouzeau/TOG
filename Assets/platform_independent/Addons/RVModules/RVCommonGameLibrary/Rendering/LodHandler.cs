...
namespace RVModules.RVCommonGameLibrary.Rendering
{
    ...
    public class LodHandler : MonoBehaviour
    {
        ...
        private MeshSwitcher[] lodSwitchers;
...
//        [SerializeField]
        ...
        public Renderer[] GetRenderersFromAllLods()
        {
            ...
            foreach (var LodSwitcher in lodSwitchers)
            {
...
//            ThreadsIds.logic);
            ...
            if (lodSwitchers.Any(l => l != null))
            {
                var a = lodSwitchers.OrderBy(_switcher => _switcher.lodMeshes.Length).LastOrDefault();
        ...
        {
            lodSwitchers = GetComponentsInChildren<MeshSwitcher>();
        ...
        private void AddLodSwitchers(bool log = false)
        {
