...
namespace BrainFailProductions.PivotModder
{
    public class PivotModderMenu : MonoBehaviour
    {
        ...
        [MenuItem("Brainfail Products/PivotModder/Enable Auto UI Attaching", false, 0)]
        ...
        [MenuItem("Brainfail Products/PivotModder/Disable Auto UI Attaching", false, 1)]
        ...
        [MenuItem("Brainfail Products/PivotModder/Attach PivotModder to Object", false, 2)]
...
#region VALIDATORS
        ...
        [MenuItem("Brainfail Products/PivotModder/Enable Auto UI Attaching", true)]
        ...
        [MenuItem("Brainfail Products/PivotModder/Disable Auto UI Attaching", true)]
