...
namespace Viveport.Internal
{
    ...
    internal partial class Api
    {
        ...
        internal static void LoadLibraryManually(string dllName)
        {
            ...
            {
#if UNITY_EDITOR
                string path = "Assets/Plugins/x86_64/" + dllName + "64.dll";
#else
                string path = dllName + "64.dll";
#endif
                IntPtr ptr = LoadLibrary(path);
                UnityEngine.Debug.Log($"LoadLibraryManually {path} {ptr}");
            }
            else
            {
#if UNITY_EDITOR
                string path = "Assets/Plugins/x86/" + dllName + ".dll";
#else
                string path = dllName + ".dll";
#endif
                IntPtr ptr = LoadLibrary(path);
                UnityEngine.Debug.Log($"LoadLibraryManually {path} {ptr}");
            }
    ...
    internal partial class User
    {
        ...
        [DllImport("viveport_api", EntryPoint = "IViveportUser_IsReady", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int IsReady(StatusCallback IsReadyCallback);

        [DllImport("viveport_api64", EntryPoint = "IViveportUser_IsReady", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    ...
    internal partial class Deeplink
    {
        ...
        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_IsReady", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void IsReady(StatusCallback IsReadyCallback);

        [DllImport("viveport_api64", EntryPoint = "IViveportDeeplink_IsReady", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void IsReady_64(StatusCallback IsReadyCallback);

        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_GoToApp", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void GoToApp(StatusCallback2 GoToAppCallback, string ViveportId, string LaunchData);

        [DllImport("viveport_api64", EntryPoint = "IViveportDeeplink_GoToApp", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void GoToApp_64(StatusCallback2 GoToAppCallback, string ViveportId, string LaunchData);

        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_GoToAppWithBranchName", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("viveport_api64", EntryPoint = "IViveportDeeplink_GoToAppWithBranchName", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_GoToStore", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_GoToAppOrGoToStore", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void GoToAppOrGoToStore(StatusCallback2 GoToAppCallback, string ViveportId, string LaunchData);

        [DllImport("viveport_api64", EntryPoint = "IViveportDeeplink_GoToAppOrGoToStore", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void GoToAppOrGoToStore_64(StatusCallback2 GoToAppCallback, string ViveportId, string LaunchData);

        [DllImport("viveport_api", EntryPoint = "IViveportDeeplink_GetAppLaunchData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int GetAppLaunchData(StringBuilder userId, int size);

        [DllImport("viveport_api64", EntryPoint = "IViveportDeeplink_GetAppLaunchData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
